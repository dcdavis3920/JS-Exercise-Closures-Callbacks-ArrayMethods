...
function processSum(numberList, callback) {
    const sum = numberList.reduce(function(accu, currentValue) {
...
function firstNamesAllCaps(runners) {
    let newArr = runners.map(function(runners) {
...
function tallyUpDonations(runners) {
    const donation = runners.reduce(function(accum, currentValue) {
